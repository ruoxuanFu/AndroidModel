...
import com.slfpro.application.constant.KeySet
import com.slfpro.application.listener.PermissionListener
...
class PermissionUtils private constructor() {
    ...
    fun getPermissionGroups(
        context: Context,
        permissionListener: PermissionListener, @NonNull permissionsGroup: ArrayList<Array<String>>
    ) {
        ...
        AndPermission.with(context)
            .runtime()
            .permission(permissionsList.joinToString())
    ...
    fun getPermissions(
        context: Context,
        permissionListener: PermissionListener, @NonNull vararg permissions: String
    ) {
        AndPermission.with(context)
            .runtime()
    ...
    fun checkPermissions(
        context: Context, @NonNull vararg permissions: String,
        ...
        AndPermission.with(context)
            ...
            .rationale { rationaleContext, data,
                ...
                AndPermission.with(context).runtime().setting()
                    .start(KeySet.REQUEST_PERMISSIONS_CODE)
            }.start()
    }
